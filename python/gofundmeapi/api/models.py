...
class Campaign(models.Model):
    ...
    percentComplete = models.DecimalField(decimal_places=2, max_digits=10)
    percentCompleteForGivenDays = models.DecimalField(decimal_places=2, max_digits=10)
    moneyPerDonor = models.DecimalField(decimal_places=2, max_digits=10)
